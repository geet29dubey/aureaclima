...
- Removed the contact assessment iframe. The translated “Build this for my business” CTA opens the matching Rooklyn HVAC locale route: `/en/`, `/es/` or `/it/`; retained Explore Rooklyn without its arrow.
